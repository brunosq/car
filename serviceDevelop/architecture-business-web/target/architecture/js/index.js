 var chinaChart;
   ...
   //订单
    ...
    function getNearMonthTrade(){
    	$.ajax({
			url : $.base+"/center/getNearMonthTrade",/* 360是江西省编码的前几位，如果不传，则表示找的全国的交易额 */
			data:{"agent_code":"36"},
			async: false,
			type : "post",
			dataType : "json",
			success : function(data) {
				...
				//var testData = [{"trade":260058330,"month":"2017-06"},{"trade":406992232,"month":"2017-05"},{"trade":209670236,"month":"2017-04"},{"trade":129880847,"month":"2017-03"},{"trade":83078393,"month":"2017-02"},{"trade":75088582,"month":"2017-01"}];
				nearMonthTrade=data;
			}
		});  	
    }
